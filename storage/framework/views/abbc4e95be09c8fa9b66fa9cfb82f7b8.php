<?php $__env->startSection('title'); ?> Settings - Goal Management <?php $__env->stopSection(); ?>
            ...
            <div class="col-span-12 lg:col-span-8">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="<?php echo e(route('goal-settings.update')); ?>" method="POST">
                            <?php echo csrf_field(); ?>
                                ...
                                <div class="space-y-4">
                                    <div class="text-center p-6 bg-blue-50 dark:bg-zink-700 rounded-lg border border-blue-200 dark:border-blue-500/30">
                                        ...
                                        <div class="relative">
                                            <input type="number" 
                                                   name="daily_goal" 
                                                   value="<?php echo e(old('daily_goal', $settings['daily_goal'])); ?>"
                                                   min="1" 
                                                   max="50"
                                                   class="form-input text-center text-2xl font-bold text-blue-600 dark:text-blue-400 dark:bg-zink-700 border-blue-200 dark:border-blue-800 focus:border-blue-500 dark:focus:border-blue-400 <?php $__errorArgs = ['daily_goal'];
                                ...
                                <div class="space-y-4">
                                    <div class="text-center p-6 bg-green-50 dark:bg-zink-700 rounded-lg border border-green-200 dark:border-green-500/30">
                                        ...
                                        <div class="relative">
                                            <input type="number" 
                                                   name="weekly_goal" 
                                                   value="<?php echo e(old('weekly_goal', $settings['weekly_goal'])); ?>"
                                                   min="1" 
                                                   max="200"
                                                   class="form-input text-center text-2xl font-bold text-green-600 dark:text-green-400 dark:bg-zink-700 border-green-200 dark:border-green-800 focus:border-green-500 dark:focus:border-green-400 <?php $__errorArgs = ['weekly_goal'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
                                ...
                                <div class="space-y-4">
                                    <div class="text-center p-6 bg-purple-50 dark:bg-zink-700 rounded-lg border border-purple-200 dark:border-purple-500/30">
                                        ...
                                        <div class="relative">
                                            <input type="number" 
                                                   name="monthly_goal" 
                                                   value="<?php echo e(old('monthly_goal', $settings['monthly_goal'])); ?>"
                                                   min="1" 
                                                   max="1000"
                                                   class="form-input text-center text-2xl font-bold text-purple-600 dark:text-purple-400 dark:bg-zink-700 border-purple-200 dark:border-purple-800 focus:border-purple-500 dark:focus:border-purple-400 <?php $__errorArgs = ['monthly_goal'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="mt-8 pt-6 border-t border-slate-200 dark:border-zink-600">
                                <div class="flex items-center justify-end gap-3">
                                    <a href="<?php echo e(route('home')); ?>" class="btn btn-sm bg-slate-500 text-white hover:bg-slate-600">
                                        Cancel
                                    </a>
...
function resetSettings() {
    if (confirm('Are you sure you want to reset all settings to default values?')) {
        window.location.href = '<?php echo e(route("goal-settings.reset")); ?>';
    }
}
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/hrm2/resources/views/goal-settings/index.blade.php ENDPATH**/ ?>