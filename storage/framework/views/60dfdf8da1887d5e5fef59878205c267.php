                ...
                <div class="card">
                    <div class="card-body">
                        <div class="flex items-center gap-3 mb-4">
                            ...
                            <div>
                                <h6 class="text-15">Submission #<?php echo e($submission->id); ?></h6>
                                <p class="text-slate-500 dark:text-zink-200">Submitted on <?php echo e($submission->created_at->format('M d, Y \a\t h:i A')); ?></p>
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                            <div>
                                ...
                                <div class="flex items-center p-3 bg-slate-50 dark:bg-zink-700 rounded-lg">
                                    <span class="text-slate-900 dark:text-zink-100 font-medium"><?php echo e($submission->employee_id); ?></span>
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <div class="flex items-center p-3 bg-slate-50 dark:bg-zink-700 rounded-lg">
                                    <span class="text-slate-900 dark:text-zink-100 font-medium"><?php echo e($submission->employee_name); ?></span>
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <div class="flex items-center p-3 bg-slate-50 dark:bg-zink-700 rounded-lg">
                                    <span class="text-slate-900 dark:text-zink-100 font-medium"><?php echo e($submission->team_lead_name); ?></span>
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <div class="flex items-center p-3 bg-slate-50 dark:bg-zink-700 rounded-lg">
                                    ...
                                    <span class="text-slate-900 dark:text-zink-100 font-medium"><?php echo e($submission->masked_phone); ?></span>
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <div class="flex items-center p-3 bg-slate-50 dark:bg-zink-700 rounded-lg">
                                    <span class="text-slate-900 dark:text-zink-100 font-medium">
                                        <?php echo e($submission->submittedBy->name ?? 'N/A'); ?>
                            ...
                            <?php if($submission->submission_type === 'csr'): ?>
                                <div>
                                    ...
                                    <div class="flex items-center p-3 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
                                        <span class="text-slate-900 dark:text-zink-100 font-medium"><?php echo e($submission->state); ?></span>
                                    </div>
                                </div>
                                ...
                                <div>
                                    ...
                                    <div class="flex items-center p-3 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
                                        <span class="text-slate-900 dark:text-zink-100 font-medium"><?php echo e($submission->zip_code); ?></span>
                                    </div>
                                </div>

                                <?php if($submission->jornaya_id): ?>
                                <div>
                                    <label class="block text-sm font-medium text-slate-500 dark:text-zink-400 mb-1">JORAYA ID</label>
                                    <div class="flex items-center p-3 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
                                        <span class="text-slate-900 dark:text-zink-100 font-medium"><?php echo e($submission->jornaya_id); ?></span>
                                    </div>
                                </div>
                                <?php endif; ?>
                            <?php endif; ?>
                            ...
                            <?php if($submission->submission_type === 'verification'): ?>
                                <div>
                                    <label class="block text-sm font-medium text-slate-500 dark:text-zink-400 mb-1">JORAYA ID</label>
                                ...
                                <div>
                                    ...
                                    <div class="flex items-center p-3 bg-green-50 dark:bg-green-900/20 rounded-lg">
                                        <span class="text-slate-900 dark:text-zink-100 font-medium"><?php echo e($submission->did); ?></span>
                                    </div>
                                </div>
                            <?php endif; ?>
                        </div>
                        ...
                        <div class="mt-4">
                            ...
                            <div class="p-3 bg-slate-50 dark:bg-zink-700 rounded-lg">
                                <p class="text-slate-900 dark:text-zink-100"><?php echo e($submission->comment); ?></p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="flex flex-col gap-2">
                            <?php if(auth()->user()->isAdmin()): ?>
                                <a href="<?php echo e(route('submissions.edit', $submission)); ?>" 
                    ...
                    <div class="card-body">
                        ...
                        <div class="space-y-3">
                            ...
                            <div class="flex items-center justify-between">
                                ...
                                <span class="text-slate-900 dark:text-zink-100 font-medium">
                                    <?php echo e($submission->created_at->format('h:i A')); ?>
                            ...
                            <div class="flex items-center justify-between">
                                ...
                                <span class="text-slate-900 dark:text-zink-100 font-medium">
                                    <?php echo e($submission->updated_at->format('M d, Y h:i A')); ?>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/hrm2/resources/views/submissions/show.blade.php ENDPATH**/ ?>