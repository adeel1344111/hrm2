<?php $__env->startSection('title', 'Today Submissions'); ?>
    ...
    <div class="container-fluid group-data-[content=boxed]:max-w-boxed mx-auto">
        <div class="flex flex-col gap-2 py-4 md:flex-row md:items-center print:hidden">
            <div class="grow">
                ...
                <p class="text-slate-500 dark:text-zink-200"><?php echo e($company); ?> · <?php echo e($periodLabel); ?> · <?php echo e($submissions->count()); ?> leads · <?php echo e($totalSales ?? 0); ?> sales</p>
            </div>
        </div>
...
<?php echo $__env->make('layouts.outsource-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/hrm2/resources/views/outsource/submissions.blade.php ENDPATH**/ ?>