                ...
                <div class="overflow-x-auto">
                    <table class="w-full whitespace-nowrap" id="contractsTable">
                        ...
                        <tbody class="bg-white divide-y divide-slate-200 dark:bg-zink-700 dark:divide-zink-500">
                            ...
                            <tr id="row-<?php echo e($employee->id); ?>" data-designation="<?php echo e($employee->designation ?? ''); ?>">
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-slate-900 dark:text-zink-100"><?php echo e($loop->iteration); ?></td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-slate-900 dark:text-zink-100"><?php echo e($employee->name); ?></td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-slate-900 dark:text-zink-100"><?php echo e($employee->employee_id); ?></td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-slate-900 dark:text-zink-100 appointment-date-cell">
                                    <?php echo e($employee->appointment_date ? \Carbon\Carbon::parse($employee->appointment_date)->format('d/m/Y') : '-'); ?>

                                </td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-slate-900 dark:text-zink-100 left-date-cell">
                                    <?php echo e($employee->left_date ? \Carbon\Carbon::parse($employee->left_date)->format('d/m/Y') : '-'); ?>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                    <div class="flex items-center space-x-2">
                                        <button type="button" 
                                                ...
                                                data-appointment="<?php echo e($employee->appointment_date ? \Carbon\Carbon::parse($employee->appointment_date)->format('Y-m-d') : ''); ?>"
                                                data-left="<?php echo e($employee->left_date ? \Carbon\Carbon::parse($employee->left_date)->format('Y-m-d') : ''); ?>"
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/hrm2/resources/views/employee_contracts/index.blade.php ENDPATH**/ ?>