    ...
    <div class="container-fluid group-data-[content=boxed]:max-w-boxed mx-auto">
        ...
        <div class="flex flex-col gap-4 md:flex-row md:items-center md:justify-between mb-6">
            <div class="flex flex-wrap items-center gap-3">
                <div class="relative">
                    <input type="month" id="report-month" value="<?php echo e($selectedMonth); ?>" class="form-input dark:bg-zink-700 dark:border-zink-500 dark:text-zink-200">
                </div>
                <div class="relative">
                    ...
                    <select id="employee-filter" class="form-select dark:bg-zink-700 dark:border-zink-500 dark:text-zink-200">
                        ...
                        <?php $__currentLoopData = $allEmployees; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $employee): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($employee->id); ?>"
                                data-designation="<?php echo e($employee->designation ?? ''); ?>"
                                data-user-type="<?php echo e($employee->user_type ?? ''); ?>"
                                <?php echo e($selectedEmployee == $employee->id ? 'selected' : ''); ?>>
                                <?php echo e($employee->name); ?> (<?php echo e($employee->employee_id ?? 'N/A'); ?>)
                            </option>
                ...
                <div class="card-body">
                    <div class="flex items-center">
                        ...
                        <div class="flex-1 ms-3">
                            ...
                            <h3 class="text-slate-900 dark:text-slate-200 text-xl font-semibold"><?php echo e(round($monthlyStats['total_days'])); ?></h3>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body">
                    <div class="flex items-center">
                        ...
                        <div class="flex-1 ms-3">
                            ...
                            <h3 class="text-slate-900 dark:text-slate-200 text-xl font-semibold"><?php echo e($monthlyStats['present']); ?></h3>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body">
                    <div class="flex items-center">
                        ...
                        <div class="flex-1 ms-3">
                            ...
                            <h3 class="text-slate-900 dark:text-slate-200 text-xl font-semibold"><?php echo e($monthlyStats['absent']); ?></h3>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body">
                    <div class="flex items-center">
                        ...
                        <div class="flex-1 ms-3">
                            ...
                            <h3 class="text-slate-900 dark:text-slate-200 text-xl font-semibold"><?php echo e($monthlyStats['attendance_rate']); ?>%</h3>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <tbody>
                            <?php $__empty_1 = true; $__currentLoopData = $employees; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $employee): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                ...
                                <tr class="bg-white border-b dark:bg-zink-700 dark:border-zink-500 hover:bg-slate-50 dark:hover:bg-zink-600 report-row"
                                    ...
                                    <td class="px-6 py-4">
                                        <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium <?php echo e($attendanceRate >= 80 ? 'text-green-600 bg-green-100 dark:bg-green-500/20 dark:text-green-400' : ($attendanceRate >= 60 ? 'text-yellow-600 bg-yellow-100 dark:bg-yellow-500/20 dark:text-yellow-400' : 'text-red-600 bg-red-100 dark:bg-red-500/20 dark:text-red-400')); ?>">
                ...
                <div class="overflow-x-auto">
                    <table class="w-full text-sm text-left text-slate-500 dark:text-zink-400">
                            ...
                            <tr>
                                ...
                                <?php for($i = 1; $i <= $daysInMonth; $i++): ?>
                                    <th scope="col" class="px-2 py-3 text-center min-w-[72px] border border-slate-200 dark:border-zink-500 whitespace-nowrap">
                                        <?php echo e($i); ?> <?php echo e($startDate->format('M')); ?>
                        ...
                        <tbody>
                                        ...
                                        <td class="px-2 py-4 border border-slate-200 dark:border-zink-500">
                                            <div class="flex items-center justify-center w-full h-full">
                                                <?php if($att): ?>
                                                    ...
                                                    ?>
                                                    <span class="flex items-center justify-center px-2 py-1 rounded text-[10px] font-bold whitespace-nowrap <?php echo e($colorClass); ?>" title="<?php echo e($cellTitle); ?>">
                                                        <?php echo e($cellText); ?>

                                                    </span>
                                                <?php elseif($isSaturday): ?>
                            ...
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                <tr>
                                    <td colspan="<?php echo e($daysInMonth + 1); ?>" class="px-6 py-4 text-center text-slate-500 dark:text-zink-400">
                                        No employees found
                                    </td>
                                </tr>
                            <?php endif; ?>
...
<script>
    ...
    function exportReport() {
        ...
        let url = '<?php echo e(route("attendance.report")); ?>?export=1&month=' + month;
        if (employee) {
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/hrm2/resources/views/attendance/report.blade.php ENDPATH**/ ?>