...
<style>
    ...
    <div class="hrm-login-card mb-0 card shadow-xl border border-slate-200 dark:border-zink-500 relative overflow-hidden">
        ...
        <div class="px-8 py-10 card-body">
            ...
            <form action="<?php echo e(route('login')); ?>" class="mt-8" method="POST" autocomplete="on">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/hrm2/resources/views/auth/login.blade.php ENDPATH**/ ?>