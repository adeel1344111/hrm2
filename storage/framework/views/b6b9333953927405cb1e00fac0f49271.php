...
<head>
    ...
    <title><?php echo e($companyDisplay); ?> — Frontor Form</title>
...
<div class="form-container">
    <div class="form-header">
        <h2 id="companyTitle"><?php echo e($companyDisplay); ?></h2>
        <p>Frontor Submission Form</p>
    </div>
    <form id="outsourceForm">
        <input type="hidden" name="company" id="company" value="<?php echo e(strtoupper($company)); ?>">
        <div class="row">
            <div>
...
(function () {
    ...
    form.addEventListener('submit', async function (e) {
        ...
        try {
            const res = await fetch(<?php echo json_encode(route('outsource.submit'), 15, 512) ?>, {
                method: 'POST',
                headers: {
                    'X-CSRF-TOKEN': csrf,
                    'Accept': 'text/plain',
            ...
            if (ok) {
                ...
                document.getElementById('company').value = <?php echo json_encode(strtoupper($company), 15, 512) ?>;
            }
        } catch (err) {
...
<?php /**PATH /var/www/hrm2/resources/views/outsource/form.blade.php ENDPATH**/ ?>