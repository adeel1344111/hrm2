<?php $__env->startSection('title'); ?> Attendance Management <?php $__env->stopSection(); ?>
    ...
    <div class="container-fluid group-data-[content=boxed]:max-w-boxed mx-auto">
        ...
        <div class="flex flex-col gap-4 md:flex-row md:items-center md:justify-between mb-6">
            <div class="flex flex-wrap items-center gap-3">
                <input type="date" id="attendance-date" value="<?php echo e($selectedDate); ?>" class="form-input">
            ...
            <div class="card-body py-3">
                <div class="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
                    <div class="text-sm font-medium text-slate-700 dark:text-zink-100">
                        Mark <span id="selected-count-bar">0</span> selected employee(s) for <span id="selected-date-label"><?php echo e($selectedDate); ?></span>
        ...
        <div class="grid grid-cols-1 gap-5 md:grid-cols-2 lg:grid-cols-4 mb-6">
            <div class="card hover:shadow-lg transition-all duration-300 cursor-pointer group">
                <div class="card-body">
                    <div class="text-center">
                        <h6 class="text-3xl font-bold text-green-600 mb-2"><?php echo e($stats['present']); ?></h6>
                        ...
                        <div class="flex items-center justify-center text-green-500 text-sm">
                            ...
                            <span><?php echo e($stats['total'] > 0 ? round(($stats['present'] / $stats['total']) * 100) : 0); ?>%</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card hover:shadow-lg transition-all duration-300 cursor-pointer group">
                <div class="card-body">
                    <div class="text-center">
                        <h6 class="text-3xl font-bold text-red-600 mb-2"><?php echo e($stats['absent']); ?></h6>
                        ...
                        <div class="flex items-center justify-center text-red-500 text-sm">
                            ...
                            <span><?php echo e($stats['total'] > 0 ? round(($stats['absent'] / $stats['total']) * 100) : 0); ?>%</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card hover:shadow-lg transition-all duration-300 cursor-pointer group">
                <div class="card-body">
                    <div class="text-center">
                        <h6 class="text-3xl font-bold text-yellow-600 mb-2"><?php echo e($stats['half_day']); ?></h6>
                        ...
                        <div class="flex items-center justify-center text-yellow-500 text-sm">
                            ...
                            <span><?php echo e($stats['total'] > 0 ? round(($stats['half_day'] / $stats['total']) * 100) : 0); ?>%</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card hover:shadow-lg transition-all duration-300 cursor-pointer group">
                <div class="card-body">
                    <div class="text-center">
                        <h6 class="text-3xl font-bold text-gray-600 mb-2"><?php echo e($stats['not_marked']); ?></h6>
                        ...
                        <div class="flex items-center justify-center text-gray-500 text-sm">
                            ...
                            <span><?php echo e($stats['total'] > 0 ? round(($stats['not_marked'] / $stats['total']) * 100) : 0); ?>%</span>
                        </div>
                    </div>
                </div>
            </div>
                                ...
                                <tbody>
                                    <?php $__empty_1 = true; $__currentLoopData = $employees; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $employee): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        ...
                                        <tr class="bg-white border-b dark:bg-zink-700 dark:border-zink-500 hover:bg-slate-50 dark:hover:bg-zink-600 attendance-row"
                                            data-designation="<?php echo e($des); ?>"
                                            data-user-type="<?php echo e($employee->user_type ?? ''); ?>"
                                            data-user-id="<?php echo e($employee->id); ?>"
                                            data-employee-code="<?php echo e($employee->employee_id ?? ''); ?>">
                                            <td class="px-3 py-4">
                                                <input type="checkbox"
                                                    class="row-select size-4 rounded border-slate-300 text-custom-500 focus:ring-custom-500"
                                                    value="<?php echo e($employee->id); ?>"
                                                    data-employee-id="<?php echo e($employee->employee_id ?? ''); ?>">
                                            </td>
                                            <td class="px-6 py-4">
                                                <div class="flex items-center">
                                                    ...
                                                    <div class="ms-3">
                                                        ...
                                                        <div class="text-sm text-slate-500 dark:text-slate-400">
                                                            <?php echo e($employee->employee_id ?? 'N/A'); ?> · <?php echo e($roleLabel); ?>
                                            ...
                                            <td class="px-6 py-4">
                                                <?php if($attendance): ?>
                                                    ...
                                                    ?>
                                                    <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium whitespace-nowrap <?php echo e($attendance->status_color); ?>">
                                                        <?php if($statusCheckIn !== ''): ?>
                                                            <?php echo e($statusCheckIn); ?>
                                            ...
                                            <td class="px-6 py-4">
                                                <input type="time" 
                                                       ...
                                                       value="<?php echo e($attendance ? $attendance->check_in_input : ''); ?>"
                                                       data-user-id="<?php echo e($employee->id); ?>"
                                                       data-field="check_in">
                                            </td>
                                            <td class="px-6 py-4">
                                                <input type="time" 
                                                       class="form-input w-32" 
                                                       value="<?php echo e($attendance ? $attendance->check_out_input : ''); ?>"
                                                       data-user-id="<?php echo e($employee->id); ?>"
                                            ...
                                            <td class="px-6 py-4">
                                                <input type="text" 
                                                       ...
                                                       placeholder="Remarks"
                                                       value="<?php echo e($attendance ? $attendance->remarks : ''); ?>"
                                                       data-user-id="<?php echo e($employee->id); ?>"
                                                       data-field="remarks">
                                            </td>
                                            <td class="px-6 py-4">
                                                <?php if($attendance && $attendance->markedBy): ?>
                                                    <span class="text-sm text-slate-600 dark:text-slate-300">
                                                        <?php echo e($attendance->markedBy->name); ?>
                                            ...
                                            <td class="px-6 py-4">
                                                <div class="flex items-center gap-2">
                                                    <select class="form-select w-32" 
                                                            data-user-id="<?php echo e($employee->id); ?>"
                                                            data-field="status">
                                                        <option value="P" <?php echo e($attendance && $attendance->status === 'P' ? 'selected' : ''); ?>>Present</option>
                                                        <option value="A" <?php echo e($attendance && $attendance->status === 'A' ? 'selected' : ''); ?>>Absent</option>
                                                        <option value="H" <?php echo e($attendance && $attendance->status === 'H' ? 'selected' : ''); ?>>Half Day</option>
                                                        <option value="U" <?php echo e($attendance && $attendance->status === 'U' ? 'selected' : ''); ?>>Unpaid</option>
                                                        <option value="NCNS" <?php echo e($attendance && $attendance->status === 'NCNS' ? 'selected' : ''); ?>>NCNS</option>
                                                        <option value="HOLIDAY" <?php echo e($attendance && $attendance->status === 'HOLIDAY' ? 'selected' : ''); ?>>Holiday</option>
                                                    </select>
                                                    <button type="button" 
                                                            class="btn bg-custom-500 text-white border-custom-500 hover:text-white hover:bg-custom-600 hover:border-custom-600 focus:text-white focus:bg-custom-600 focus:border-custom-600 focus:ring focus:ring-custom-100 active:text-white active:bg-custom-600 active:border-custom-600 active:ring active:ring-custom-100 dark:ring-custom-400/20"
                                                            onclick="markAttendance(<?php echo e($employee->id); ?>)">
                                                    ...
                                                    <button type="button" 
                                                            ...
                                                            onclick="deleteAttendance(<?php echo e($attendance->id); ?>)">
...
<script>
    ...
    document.getElementById('confirm-mark-selected-btn')?.addEventListener('click', function() {
        ...
        fetch('<?php echo e(route("attendance.bulk-mark")); ?>', {
            method: 'POST',
            headers: {
    ...
    function markAttendance(userId) {
        ...
        fetch('<?php echo e(route("attendance.mark")); ?>', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
                'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>'
    ...
    const allEmployees = [
        <?php $__currentLoopData = $allEmployees ?? $employees; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $employee): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        {
            user_id: <?php echo e($employee->id); ?>,
            employee_id: "<?php echo e($employee->employee_id ?? ''); ?>",
            name: <?php echo json_encode($employee->name, 15, 512) ?>,
            designation: <?php echo json_encode($employee->designation ?? '', 15, 512) ?>,
            user_type: <?php echo json_encode($employee->user_type ?? '', 15, 512) ?>
        },
    ...
    document.getElementById('bulk-mark-form').addEventListener('submit', function(e) {
        ...
        if (status === 'DELETE') {
            url = '<?php echo e(route("attendance.bulk-delete")); ?>';
            body = {
                from_date: fromDate,
                to_date: toDate,
            ...
            url = '<?php echo e(route("attendance.bulk-mark")); ?>';
            body = {
                from_date: fromDate,
                to_date: toDate,
    ...
    if (cleanupBtn) {
        cleanupBtn.addEventListener('click', function() {
            ...
            fetch("<?php echo e(route('attendance.invalid-records')); ?>")
            .then(response => {
    ...
    if (confirmCleanupBtn) {
        confirmCleanupBtn.addEventListener('click', function() {
            ...
            fetch("<?php echo e(route('attendance.cleanup')); ?>", {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/hrm2/resources/views/attendance/index.blade.php ENDPATH**/ ?>