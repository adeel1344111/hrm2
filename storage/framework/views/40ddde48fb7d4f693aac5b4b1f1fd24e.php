<?php $__env->startSection('title'); ?> Active Employees <?php $__env->stopSection(); ?>
        ...
        <div class="flex flex-col gap-2 py-4 md:flex-row md:items-center print:hidden">
            ...
            <div class="grid grid-cols-1 gap-5 md:grid-cols-2 lg:grid-cols-4 mb-6">
                <div class="card hover:shadow-lg transition-all duration-300 cursor-pointer group">
                    <div class="card-body">
                        <div class="text-center">
                            <h6 class="text-3xl font-bold text-green-600 mb-2"><?php echo e($stats['active_csr']); ?></h6>
                ...
                <div class="card hover:shadow-lg transition-all duration-300 cursor-pointer group">
                    <div class="card-body">
                        <div class="text-center">
                            <h6 class="text-3xl font-bold text-blue-600 mb-2"><?php echo e($stats['active_verifiers']); ?></h6>
                            ...
                            <div class="flex items-center justify-center text-blue-500 text-sm">
                                ...
                                <span><?php echo e($stats['total'] > 0 ? round(($stats['active_verifiers'] / $stats['total']) * 100) : 0); ?>%</span>
                            </div>
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/hrm2/resources/views/employees/active.blade.php ENDPATH**/ ?>