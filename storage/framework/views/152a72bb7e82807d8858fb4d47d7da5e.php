<?php $__env->startSection('title'); ?> Request Leave <?php $__env->stopSection(); ?>
                        ...
                        <form action="<?php echo e(route('leaves.store')); ?>" method="POST">
                            ...
                            <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                                <div>
                                    ...
                                    <select class="form-input w-full <?php $__errorArgs = ['leave_type'];
...
unset($__errorArgs, $__bag); ?>" id="leave_type" name="leave_type" required>
                                        ...
                                        <?php $__currentLoopData = $leaveTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $leaveType): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($leaveType->name); ?>" <?php echo e(old('leave_type') == $leaveType->name ? 'selected' : ''); ?>>
                                                <?php echo e($leaveType->name); ?>

                                                <?php if($leaveType->max_days): ?>
                                                    (Max: <?php echo e($leaveType->max_days); ?> days)
                                                <?php endif; ?>
                                            </option>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="grid grid-cols-1 gap-6 md:grid-cols-2 mt-6">
                                <div>
                                    ...
                                    <input type="date" class="form-input w-full <?php $__errorArgs = ['start_date'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" id="start_date" name="start_date" value="<?php echo e(old('start_date')); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div>
                                    ...
                                    <input type="date" class="form-input w-full <?php $__errorArgs = ['end_date'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="mt-6">
                                ...
                                <textarea class="form-input w-full <?php $__errorArgs = ['reason'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" id="reason" name="reason" rows="4" placeholder="Please provide a detailed reason for your leave request..." required><?php echo e(old('reason')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="flex gap-3 mt-6">
                                ...
                                <a href="<?php echo e(route('leaves.index')); ?>" class="btn bg-slate-200 text-slate-800 btn-md">
                        ...
                        <?php $__currentLoopData = $leaveTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $leaveType): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="flex items-center justify-between p-3 border border-slate-200 dark:border-zink-500 rounded-lg">
                                <div class="flex items-center">
                                    <span class="badge bg-custom-100 text-custom-600 me-2"><?php echo e($leaveType->name); ?></span>
                                    <small class="text-slate-500 dark:text-zink-400"><?php echo e($leaveType->description); ?></small>
                        </div>
                                <?php if($leaveType->max_days): ?>
                                    <span class="text-xs text-slate-400 dark:text-zink-500">Max: <?php echo e($leaveType->max_days); ?> days</span>
                                <?php endif; ?>
                        </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/hrm2/resources/views/leaves/create.blade.php ENDPATH**/ ?>