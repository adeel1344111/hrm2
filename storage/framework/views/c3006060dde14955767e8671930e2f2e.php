<?php $__env->startSection('title'); ?> Create Submission <?php $__env->stopSection(); ?>
    ...
    <div class="container-fluid group-data-[content=boxed]:max-w-boxed mx-auto">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <form action="<?php echo e(route('submissions.store')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="grid grid-cols-1 gap-5 lg:grid-cols-2">
                        ...
                        <div>
                            ...
                            <input type="text" id="employee_id" name="employee_id" value="<?php echo e(old('employee_id', $user->employee_id)); ?>" 
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="text" id="employee_name" name="employee_name" value="<?php echo e(old('employee_name', $user->name)); ?>" 
                                   class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 bg-slate-100 dark:bg-zink-600 border-slate-300 dark:border-zink-500 text-slate-500 dark:text-zink-200 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200"
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="text" id="team_lead_name" name="team_lead_name" value="<?php echo e(old('team_lead_name', $teamLeadName ?? 'Not Assigned')); ?>" 
                                   class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 bg-slate-100 dark:bg-zink-600 border-slate-300 dark:border-zink-500 text-slate-500 dark:text-zink-200 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200"
                                   placeholder="Team Lead Name" readonly>
                            <?php $__errorArgs = ['team_lead_name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                        ...
                        <div>
                            ...
                            <select id="campaign" name="campaign" 
                                ...
                                <?php if(count($campaigns) > 0): ?>
                                    ...
                                    <option value="<?php echo e($campaign); ?>" <?php echo e((old('campaign', $lastCampaign) === $campaign) ? 'selected' : ''); ?>>
                                        <?php echo e($campaign); ?>
                                ...
                                <div class="p-4 mb-4 border-2 border-blue-200 rounded-lg bg-blue-50 dark:bg-blue-900/20 dark:border-blue-800">
                                    ...
                                    <div class="grid grid-cols-1 gap-5 lg:grid-cols-2">
                                        <div class="lg:col-span-2">
                                            ...
                                            <input type="text" id="jornaya_id" name="jornaya_id" value="<?php echo e(old('jornaya_id')); ?>" 
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div>
                                            ...
                                            <input type="text" id="zip_code" name="zip_code" value="<?php echo e(old('zip_code')); ?>" 
                                                   class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200"
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div>
                                            ...
                                            <input type="text" id="did" name="did" value="<?php echo e(old('did')); ?>" 
                                                   class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200"
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <?php else: ?>
                            ...
                            <?php if(auth()->user()->designation == 'CSR' || auth()->user()->isCsr()): ?>
                                <div class="lg:col-span-2">
                                    <label for="jornaya_id" class="inline-block mb-2 text-base font-semibold text-blue-700 dark:text-blue-400">JORAYA ID (Self Closer)</label>
                                    <input type="text" id="jornaya_id" name="jornaya_id" value="<?php echo e(old('jornaya_id')); ?>" 
                                           class="form-input border-blue-300 dark:border-blue-800 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200 bg-blue-50/50 dark:bg-blue-900/10"
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <?php if($user->isVerificationOfficer()): ?>
                                <div>
                                ...
                                <div>
                                    ...
                                    <div class="flex items-center">
                                        ...
                                        <input type="text" id="did_extension" 
                                               ...
                                               value="<?php echo e(old('did') ? substr(old('did'), 1) : ''); ?>" required>
                                    </div>
                                    <input type="hidden" id="did" name="did" value="<?php echo e(old('did')); ?>">
                                    <?php $__errorArgs = ['did'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="lg:col-span-2">
                            ...
                            <textarea id="comment" name="comment" rows="4" 
                                      class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200"
                                      placeholder="Enter your comment (optional)"><?php echo e(old('comment')); ?></textarea>
...
<script src="<?php echo e(URL::asset('assets/js/pages/submission-google-sheets.js')); ?>"></script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/hrm2/resources/views/submissions/create.blade.php ENDPATH**/ ?>