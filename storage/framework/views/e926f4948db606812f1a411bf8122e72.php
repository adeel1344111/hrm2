                ...
                <div class="overflow-x-auto">
                    <table class="w-full whitespace-nowrap" id="salariesTable">
                        ...
                        <tbody class="bg-white divide-y divide-slate-200 dark:bg-zink-700 dark:divide-zink-500">
                            ...
                            <tr id="row-<?php echo e($user->id); ?>" data-designation="<?php echo e($user->designation ?? ''); ?>">
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-slate-900 dark:text-zink-100"><?php echo e($user->name); ?></td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-slate-900 dark:text-zink-100"><?php echo e($user->employee_id); ?></td>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-slate-900 dark:text-zink-100 punctuality-cell"><?php echo e(number_format($user->current_salary->punctuality ?? 0)); ?></td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-slate-900 dark:text-zink-100 basic-salary-cell"><?php echo e(number_format($user->current_salary->basic_salary ?? 0)); ?></td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-slate-900 dark:text-zink-100 temp-salary-cell"><?php echo e(isset($user->current_salary->temp_salary) ? number_format($user->current_salary->temp_salary) : '-'); ?></td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-slate-900 dark:text-zink-100 last-salary-cell">
                                    <?php echo e($user->last_total_salary ? number_format($user->last_total_salary) : '-'); ?>

                                </td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-slate-500 dark:text-zink-400 updated-at-cell">
                                    <?php echo e($user->current_salary && $user->current_salary->updated_at ? $user->current_salary->updated_at->diffForHumans() : '-'); ?>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                    <div class="flex items-center space-x-2">
                                        <button type="button" 
                                                ...
                                                data-basic="<?php echo e($user->current_salary->basic_salary ?? 0); ?>"
                                                data-punctuality="<?php echo e($user->current_salary->punctuality ?? 0); ?>"
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/hrm2/resources/views/salary_info/index.blade.php ENDPATH**/ ?>