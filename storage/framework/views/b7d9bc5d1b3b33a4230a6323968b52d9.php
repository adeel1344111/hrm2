...
<?php $__env->startSection('title'); ?> User Settings <?php $__env->stopSection(); ?>
                    ...
                    <div class="card-body">
                        ...
                        <div class="space-y-3">
                            <div class="flex items-center justify-between">
                                ...
                                <span class="font-medium"><?php echo e(ucfirst($user->user_type)); ?></span>
                            </div>
                            <div class="flex items-center justify-between">
                                <span class="text-slate-500 dark:text-zink-200">Department</span>
                                <span class="font-medium"><?php echo e($user->department ?? 'N/A'); ?></span>
                            </div>
                            <div class="flex items-center justify-between">
                                <span class="text-slate-500 dark:text-zink-200">Designation</span>
                                <span class="font-medium"><?php echo e($user->designation ?? 'N/A'); ?></span>
                            </div>
                            <div class="flex items-center justify-between">
                                <span class="text-slate-500 dark:text-zink-200">Join Date</span>
                                <span class="font-medium"><?php echo e($user->join_date ? $user->join_date->format('M d, Y') : 'N/A'); ?></span>
                            </div>
                            <div class="flex items-center justify-between">
                                <span class="text-slate-500 dark:text-zink-200">Status</span>
                                <span class="px-2.5 py-0.5 text-xs font-medium rounded border <?php echo e($user->status == 'active' ? 'bg-green-100 border-green-200 text-green-500' : 'bg-red-100 border-red-200 text-red-500'); ?>">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/hrm2/resources/views/settings/index.blade.php ENDPATH**/ ?>