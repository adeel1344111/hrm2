<?php $__env->startSection('title'); ?> All Employees <?php $__env->stopSection(); ?>
        ...
        <div class="flex flex-col gap-2 py-4 md:flex-row md:items-center print:hidden">
            ...
            <div class="grid grid-cols-1 gap-5 md:grid-cols-2 lg:grid-cols-4 mb-6">
                ...
                <div class="card hover:shadow-lg transition-all duration-300 cursor-pointer group">
                    <div class="card-body">
                        <div class="text-center">
                            <h6 class="text-3xl font-bold text-green-600 dark:text-green-400 mb-2"><?php echo e($stats['active']); ?></h6>
                            ...
                            <div class="flex items-center justify-center text-green-500 dark:text-green-400 text-sm">
                                ...
                                <span><?php echo e($stats['total'] > 0 ? round(($stats['active'] / $stats['total']) * 100) : 0); ?>%</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card hover:shadow-lg transition-all duration-300 cursor-pointer group">
                    <div class="card-body">
                        <div class="text-center">
                            <h6 class="text-3xl font-bold text-red-600 dark:text-red-400 mb-2"><?php echo e($stats['inactive']); ?></h6>
                            ...
                            <div class="flex items-center justify-center text-red-500 dark:text-red-400 text-sm">
                                ...
                                <span><?php echo e($stats['total'] > 0 ? round(($stats['inactive'] / $stats['total']) * 100) : 0); ?>%</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card hover:shadow-lg transition-all duration-300 cursor-pointer group">
                    <div class="card-body">
                        <div class="text-center">
                            <h6 class="text-3xl font-bold text-purple-600 dark:text-purple-400 mb-2"><?php echo e($stats['agents']); ?></h6>
                            ...
                            <div class="flex items-center justify-center text-purple-500 dark:text-purple-400 text-sm">
                                ...
                                <span><?php echo e($stats['total'] > 0 ? round(($stats['agents'] / $stats['total']) * 100) : 0); ?>%</span>
                            </div>
                        </div>
                    </div>
                </div>
             ...
             <div class="flex flex-wrap items-center justify-between gap-4 mb-6">
                 <div class="flex items-center gap-3">
                     <?php if(auth()->user()->isAdmin() || auth()->user()->isFloorManager()): ?>
                     <a href="<?php echo e(route('employees.create')); ?>" class="text-white btn bg-custom-500 border-custom-500 hover:text-white hover:bg-custom-600 hover:border-custom-600 focus:text-white focus:bg-custom-600 focus:border-custom-600 focus:ring focus:ring-custom-100 active:text-white active:bg-custom-600 active:border-custom-600 active:ring active:ring-custom-100 dark:ring-custom-400/20">
                                ...
                                <tr class="hover:bg-slate-50 dark:hover:bg-zink-600">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium
                                            <?php if($employee->user_type === 'agent'): ?> bg-blue-100 text-blue-800 dark:bg-blue-500/20 dark:text-blue-400
                                            <?php elseif($employee->user_type === 'team_lead'): ?> bg-purple-100 text-purple-800 dark:bg-purple-500/20 dark:text-purple-400
                                            <?php elseif($employee->user_type === 'floor_manager'): ?> bg-orange-100 text-orange-800 dark:bg-orange-500/20 dark:text-orange-400
                                            <?php elseif($employee->user_type === 'management'): ?> bg-teal-100 text-teal-800 dark:bg-teal-500/20 dark:text-teal-400
                                            <?php elseif($employee->user_type === 'admin'): ?> bg-rose-100 text-rose-800 dark:bg-rose-500/20 dark:text-rose-400
                                         ...
                                         <div class="flex items-center space-x-2">
                                             ...
                                             <span id="status-container-<?php echo e($employee->id); ?>">
                                                 <?php if($employee->status === 'active'): ?>
                                                     <button onclick="toggleEmployeeStatus(<?php echo e($employee->id); ?>, 'inactive')" class="text-yellow-600 hover:text-yellow-900 dark:text-yellow-400 dark:hover:text-yellow-300" title="Deactivate">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/hrm2/resources/views/employees/index.blade.php ENDPATH**/ ?>