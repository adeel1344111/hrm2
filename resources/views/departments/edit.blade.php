                ...
                <form action="{{ route('departments.update', $department) }}" method="POST">
                    ...
                    <div class="grid grid-cols-1 gap-5 lg:grid-cols-2">
                        <div class="lg:col-span-2">
                            <label for="name" class="inline-block mb-2 text-base font-medium">Department Name <span class="text-red-500">*</span></label>
                        ...
                        <div>
                            <label for="code" class="inline-block mb-2 text-base font-medium">Department Code <span class="text-red-500">*</span></label>
