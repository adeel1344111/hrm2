    ...
    <div class="container-fluid group-data-[content=boxed]:max-w-boxed mx-auto">
        ...
        <div class="grid grid-cols-1 gap-5 md:grid-cols-2 lg:grid-cols-4 mb-6">
            <div class="card hover:shadow-lg transition-all duration-300 cursor-pointer group">
                <div class="card-body">
                    <div class="text-center">
                        <h6 class="text-3xl font-bold text-purple-600 mb-2">{{ $campaigns->total() }}</h6>
            ...
            <div class="card hover:shadow-lg transition-all duration-300 cursor-pointer group">
                <div class="card-body">
                    <div class="text-center">
                        <h6 class="text-3xl font-bold text-green-600 mb-2">{{ $campaigns->where('status', 'active')->count() }}</h6>
                        ...
                        <div class="flex items-center justify-center text-green-500 text-sm">
                            ...
                            <span>{{ $campaigns->total() > 0 ? round(($campaigns->where('status', 'active')->count() / $campaigns->total()) * 100) : 0 }}%</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card hover:shadow-lg transition-all duration-300 cursor-pointer group">
                <div class="card-body">
                    <div class="text-center">
                        <h6 class="text-3xl font-bold text-blue-600 mb-2">{{ $campaigns->where('status', 'completed')->count() }}</h6>
                        ...
                        <div class="flex items-center justify-center text-blue-500 text-sm">
                            ...
                            <span>{{ $campaigns->total() > 0 ? round(($campaigns->where('status', 'completed')->count() / $campaigns->total()) * 100) : 0 }}%</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card hover:shadow-lg transition-all duration-300 cursor-pointer group">
                <div class="card-body">
                    <div class="text-center">
                        <h6 class="text-3xl font-bold text-orange-600 mb-2">{{ $campaigns->where('status', 'inactive')->count() }}</h6>
                        ...
                        <div class="flex items-center justify-center text-orange-500 text-sm">
                            ...
                            <span>{{ $campaigns->total() > 0 ? round(($campaigns->where('status', 'inactive')->count() / $campaigns->total()) * 100) : 0 }}%</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card-body">
                <div class="flex flex-col gap-4 md:flex-row md:items-center md:justify-between mb-6">
                    ...
                    <div class="flex items-center gap-3">
                        <a href="{{ route('campaigns.create') }}" class="btn bg-custom-500 text-white border-custom-500 hover:text-white hover:bg-custom-600 hover:border-custom-600 focus:text-white focus:bg-custom-600 focus:border-custom-600 focus:ring focus:ring-custom-100 active:text-white active:bg-custom-600 active:border-custom-600 active:ring active:ring-custom-100 dark:ring-custom-400/20">
                            ...
                            <tr class="hover:bg-slate-50 dark:hover:bg-zink-600 transition-colors">
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex items-center">
                                        ...
                                        <div class="ms-3">
                                            <div class="text-sm font-medium text-slate-900 dark:text-zink-100">{{ $campaign->name }}</div>
                                            <div class="text-sm text-slate-500 dark:text-zink-400">{{ Str::limit($campaign->description, 50) }}</div>
                                        </div>
                                    </div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                    <div class="flex items-center space-x-2">
                                        <a href="{{ route('campaigns.show', $campaign) }}" class="text-blue-600 hover:text-blue-900 dark:text-blue-400 dark:hover:text-blue-300" title="View Details">
                                            <i data-lucide="eye" class="w-4 h-4"></i>
                                        </a>
                                        <a href="{{ route('campaigns.edit', $campaign) }}" class="text-green-600 hover:text-green-900 dark:text-green-400 dark:hover:text-green-300" title="Edit Campaign">
