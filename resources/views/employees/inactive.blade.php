...
@section('title') Inactive Employees @endsection
@section('content')
<!-- Page-content -->
        ...
        <div class="flex flex-col gap-2 py-4 md:flex-row md:items-center print:hidden">
            ...
            <div class="grid grid-cols-1 gap-5 md:grid-cols-2 lg:grid-cols-4 mb-6">
                <div class="card hover:shadow-lg transition-all duration-300 cursor-pointer group">
                    <div class="card-body">
                        <div class="text-center">
                            <h6 class="text-3xl font-bold text-red-600 mb-2">{{ $stats['inactive_csr'] }}</h6>
                ...
                <div class="card hover:shadow-lg transition-all duration-300 cursor-pointer group">
                    <div class="card-body">
                        <div class="text-center">
                            <h6 class="text-3xl font-bold text-blue-600 mb-2">{{ $stats['inactive_verifiers'] }}</h6>
                            ...
                            <div class="flex items-center justify-center text-blue-500 text-sm">
                                ...
                                <span>{{ $stats['total'] > 0 ? round(($stats['inactive_verifiers'] / $stats['total']) * 100) : 0 }}%</span>
                            </div>
                        </div>
                    </div>
                </div>
