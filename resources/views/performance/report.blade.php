...
@section('title') Performance Report @endsection
@section('content')
<!-- Page-content -->
    ...
    <div class="container-fluid group-data-[content=boxed]:max-w-boxed mx-auto">
        ...
        <div class="card">
            <div class="card-body">
                ...
                @foreach($performanceData as $campaignName => $agentsData)
                <div class="mb-8 bg-white dark:bg-zink-700 rounded-md shadow-sm border border-slate-200 dark:border-zink-500 overflow-hidden">
                    <div class="p-4 bg-slate-50 dark:bg-zink-600 border-b border-slate-200 dark:border-zink-500">
                        <h5 class="text-16 font-semibold">{{ $campaignName }}</h5>
                    </div>
                        ...
                        <table class="w-full text-left border-collapse performance-table">
                            <thead>
                                <tr class="bg-slate-50 dark:bg-zink-600">
                                    ...
                                    @endif
                                    {{-- Hours are now passed from controller --}}
...
function exportToExcel() {
    ...
    link.setAttribute('download', 'performance_report_{{ now()->format('Y-m-d_H-i') }}.csv');
