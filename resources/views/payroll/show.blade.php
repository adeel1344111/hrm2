...
@section('title') Payroll Details @endsection
@section('content')
<!-- Page-content -->
            ...
            <div class="card">
                <div class="card-body">
                    <div class="flex flex-col items-center justify-center py-12">
                        ...
                        <p class="text-slate-500 dark:text-zink-400 mb-6">{{ $error ?? 'No payroll data found for this employee.' }}</p>
                        ...
                        @else
                            <a href="{{ route('payroll.index') }}" class="text-white btn bg-custom-500 border-custom-500 hover:text-white hover:bg-custom-600 hover:border-custom-600">
            ...
            <div class="card-body">
                    <div class="flex flex-col gap-4 md:flex-row md:items-center md:justify-between mb-6">
                        <div>
                            ...
                            <p class="text-slate-500 dark:text-zink-200">Detailed breakdown of salary calculation for {{ $payroll['name'] }}</p>
                        </div>
                        <div class="flex gap-2">
                            @if(!auth()->user()->isAgent())
                            <a href="{{ route('payroll.index', ['last_month' => $lastMonth]) }}" 
                                    ...
                                    <div class="flex items-center">
                                        <div class="w-12 h-12 rounded-full bg-slate-200 dark:bg-zink-600 flex items-center justify-center mr-4">
                                            <span class="text-lg font-medium text-slate-800 dark:text-zink-200">
                                                {{ implode('', array_map(function($word) { return strtoupper(substr($word, 0, 1)); }, explode(' ', $payroll['name']))) }}
                                            </span>
                                        </div>
                                        <div>
                                            <h6 class="font-semibold text-slate-900 dark:text-zink-100">{{ $payroll['name'] }}</h6>
                                            <p class="text-sm text-slate-500 dark:text-zink-400">{{ $payroll['employee_code'] }}</p>
                                        </div>
                                    </div>
                                    <div class="flex justify-between">
                                        <span class="text-slate-500 dark:text-zink-400">User Type:</span>
                                        <span class="font-medium">{{ ucfirst(str_replace('_', ' ', $payroll['user_type'])) }}</span>
                                    </div>
                                    <div class="flex justify-between">
                                        <span class="text-slate-500 dark:text-zink-400">Department:</span>
                                        <span class="font-medium">{{ $payroll['department'] ?? 'N/A' }}</span>
                                    </div>
                                    <div class="flex justify-between">
                            ...
                            <div class="card-body">
                                ...
                                <div class="space-y-3">
                                    <div class="flex justify-between">
                                        ...
                                        <span class="font-medium">PKR {{ number_format($payroll['basic_salary']) }}</span>
                                    </div>
                                    <div class="flex justify-between">
                                        <span class="text-slate-500 dark:text-zink-400">Punctuality:</span>
                                        <span class="font-medium">PKR {{ number_format($payroll['punctuality']) }}</span>
                                    </div>
                                    <div class="flex justify-between">
                                        <span class="text-slate-500 dark:text-zink-400">Working Days:</span>
                                        <span class="font-medium">{{ $payroll['total_working_days'] }}</span>
                                    </div>
                                    <div class="flex justify-between border-t border-slate-200 dark:border-zink-500 pt-3">
                                        ...
                                        <span class="text-lg font-bold text-custom-500 dark:text-custom-400">PKR {{ number_format($payroll['final_salary']) }}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="space-y-3">
                                    <div class="flex justify-between">
                                        ...
                                        <span class="font-medium text-green-600 dark:text-green-400">{{ $payroll['presents'] }}</span>
                                    </div>
                                    <div class="flex justify-between">
                                        <span class="text-slate-500 dark:text-zink-400">Absent Days:</span>
                                        <span class="font-medium text-red-600 dark:text-red-400">{{ $payroll['absent_count'] }}</span>
                                    </div>
                                    <div class="flex justify-between">
                                        <span class="text-slate-500 dark:text-zink-400">NCNS Days:</span>
                                        <span class="font-medium text-orange-600 dark:text-orange-400">{{ $payroll['ncns_count'] }}</span>
                                    </div>
                                    <div class="flex justify-between">
                                        <span class="text-slate-500 dark:text-zink-400">Half Days:</span>
                                        <span class="font-medium text-blue-600 dark:text-blue-400">{{ $payroll['half_days'] }}</span>
                                    </div>
                                    <div class="flex justify-between">
                                        <span class="text-slate-500 dark:text-zink-400">Holidays:</span>
                                        <span class="font-medium text-purple-600 dark:text-purple-400">{{ $payroll['holiday_count'] }}</span>
                                    </div>
                                    <div class="flex justify-between">
                                        <span class="text-slate-500 dark:text-zink-400">Unpaid Days:</span>
                                        <span class="font-medium text-gray-600 dark:text-gray-400">{{ $payroll['unpaid_count'] }}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="space-y-3">
                                    @if($payroll['late_deduction'] > 0)
                                        <div class="flex justify-between">
                                            ...
                                            <span class="font-medium text-red-600 dark:text-red-400">-PKR {{ number_format($payroll['late_deduction']) }}</span>
                                        </div>
                                    @endif
                                    @if($payroll['dock'] > 0)
                                        <div class="flex justify-between">
                                            <span class="text-slate-500 dark:text-zink-400">Dock:</span>
                                            <span class="font-medium text-red-600 dark:text-red-400">-PKR {{ number_format($payroll['dock']) }}</span>
                                        </div>
                                    @endif
                                    @if($payroll['training_bonus'] > 0)
                                        <div class="flex justify-between">
                                            <span class="text-slate-500 dark:text-zink-400">Training Bonus:</span>
                                            <span class="font-medium text-green-600 dark:text-green-400">+PKR {{ number_format($payroll['training_bonus']) }}</span>
                                        </div>
                                    @endif
                                    @if(isset($payroll['arrears_amount']) && $payroll['arrears_amount'] > 0)
                                        <div class="flex justify-between">
                                            <span class="text-slate-500 dark:text-zink-400">Dec Salary Arrears:</span>
                                            <span class="font-medium text-green-600 dark:text-green-400">+PKR {{ number_format($payroll['arrears_amount']) }}</span>
                                        </div>
                                    @endif
                                    ...
                                    @if($payroll['bonus'] > 0)
                                        <div class="flex justify-between">
                                            ...
                                            <span class="font-medium text-green-600 dark:text-green-400">+PKR {{ number_format($payroll['bonus']) }}</span>
                                        </div>
                                    @endif
                                    @if($payroll['ref_bonus'] > 0)
                                        <div class="flex justify-between">
                                            <span class="text-slate-500 dark:text-zink-400">Referral Bonus:</span>
                                            <span class="font-medium text-green-600 dark:text-green-400">+PKR {{ number_format($payroll['ref_bonus']) }}</span>
                                        </div>
                                    @endif
                                    @if($payroll['late_deduction'] == 0 && $payroll['dock'] == 0 && $payroll['training_bonus'] == 0 && $payroll['bonus'] == 0 && $payroll['ref_bonus'] == 0)
                                ...
                                <table class="w-full text-sm text-left text-slate-500 dark:text-zink-200">
                                    ...
                                    <tbody>
                                        <tr class="bg-white border-b border-slate-200 dark:bg-zink-700 dark:border-zink-500">
                                            ...
                                            <td class="px-6 py-4">{{ number_format($payroll['basic_salary']) }} ÷ {{ $payroll['total_working_days'] }}</td>
                                            <td class="px-6 py-4">PKR {{ number_format($payroll['basic_salary'] / $payroll['total_working_days']) }}</td>
                                        </tr>
                                        <tr class="bg-white border-b border-slate-200 dark:bg-zink-700 dark:border-zink-500">
                                            <td class="px-6 py-4 font-medium text-slate-900 dark:text-zink-100">Present Days Pay</td>
                                            <td class="px-6 py-4">{{ number_format($payroll['basic_salary'] / $payroll['total_working_days']) }} × {{ $payroll['presents'] }}</td>
                                            <td class="px-6 py-4">PKR {{ number_format(($payroll['basic_salary'] / $payroll['total_working_days']) * $payroll['presents']) }}</td>
                                        </tr>
                                        <tr class="bg-white border-b border-slate-200 dark:bg-zink-700 dark:border-zink-500">
                                            <td class="px-6 py-4 font-medium text-slate-900 dark:text-zink-100">Half Days Pay</td>
                                            <td class="px-6 py-4">{{ number_format($payroll['basic_salary'] / $payroll['total_working_days']) }} × {{ $payroll['half_days'] }}</td>
                                            <td class="px-6 py-4">PKR {{ number_format(($payroll['basic_salary'] / $payroll['total_working_days']) * $payroll['half_days']) }}</td>
                                        </tr>
                                        <tr class="bg-white border-b border-slate-200 dark:bg-zink-700 dark:border-zink-500">
                                            <td class="px-6 py-4 font-medium text-slate-900 dark:text-zink-100">Holiday Pay</td>
                                            <td class="px-6 py-4">{{ number_format($payroll['basic_salary'] / $payroll['total_working_days']) }} × {{ $payroll['holiday_count'] }}</td>
                                            <td class="px-6 py-4">PKR {{ number_format(($payroll['basic_salary'] / $payroll['total_working_days']) * $payroll['holiday_count']) }}</td>
                                        </tr>
                                        @if(isset($payroll['arrears_amount']) && $payroll['arrears_amount'] > 0)
                                            <tr class="bg-white border-b border-slate-200 dark:bg-zink-700 dark:border-zink-500">
                                                ...
                                                <td class="px-6 py-4 font-medium text-green-600 dark:text-green-400">+PKR {{ number_format($payroll['arrears_amount']) }}</td>
                                            </tr>
                                        @endif
                                        <tr class="bg-white border-b border-slate-200 dark:bg-zink-700 dark:border-zink-500">
                                            ...
                                            <td class="px-6 py-4">
                                                @if(isset($payroll['actual_punctuality']) && $payroll['actual_punctuality'] < $payroll['punctuality'])
                                                    <span class="text-red-500 line-through mr-2">PKR {{ number_format($payroll['punctuality']) }}</span>
                                                    <span>PKR {{ number_format($payroll['actual_punctuality']) }}</span>
                                                @else
                                                    PKR {{ number_format($payroll['punctuality']) }}
                                                @endif
                                            </td>
                                        </tr>
                                        @if($payroll['late_count'] > 0)
                                            <tr class="bg-white border-b border-slate-200 dark:bg-zink-700 dark:border-zink-500">
                                                ...
                                                <td class="px-6 py-4">{{ $payroll['late_count'] }} times</td>
                                                <td class="px-6 py-4 text-red-600 dark:text-red-400">-PKR {{ number_format($payroll['late_deduction']) }}</td>
                                            </tr>
                                        @endif
                                        <tr class="bg-slate-50 dark:bg-zink-600">
                                            ...
                                            <td class="px-6 py-4 font-bold text-custom-500 dark:text-custom-400">PKR {{ number_format($payroll['final_salary']) }}</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
