                    ...
                    <div class="card-body px-6 py-6 text-center">
                        <div class="mb-4">
                            @if($user->profile_picture)
                                <img src="{{ asset('assets/images/' . $user->profile_picture) }}" alt="Profile Picture" 
                        ...
                        <div class="space-y-2">
                            <!-- Upload New Picture -->
                            <form action="{{ route('profile.update-picture') }}" method="POST" enctype="multipart/form-data" class="inline-block">
                                @csrf
                            ...
                            @if($user->profile_picture)
                            <!-- Remove Picture -->
                            <form action="{{ route('profile.remove-picture') }}" method="POST" class="inline-block">
                                @csrf
                    ...
                    <div class="card-body px-6 py-6">
                        <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                            ...
                            <div>
                                ...
                                <div class="form-input bg-slate-100 dark:bg-zink-600 border-slate-300 dark:border-zink-500 text-slate-500 dark:text-zink-200" readonly>
                                    {{ $user->appointment_date ? \Carbon\Carbon::parse($user->appointment_date)->format('M d, Y') : 'N/A' }}
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <div class="form-input bg-slate-100 dark:bg-zink-600 border-slate-300 dark:border-zink-500 text-slate-500 dark:text-zink-200" readonly>
                                    {{ $user->join_date ? \Carbon\Carbon::parse($user->join_date)->format('M d, Y') : 'N/A' }}
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <div class="form-input bg-slate-100 dark:bg-zink-600 border-slate-300 dark:border-zink-500 text-slate-500 dark:text-zink-200" readonly>
                                    <span class="badge {{ $user->status === 'active' ? 'bg-green-100 text-green-600' : 'bg-red-100 text-red-600' }}">
                                        {{ ucfirst($user->status) }}
                                    </span>
                                </div>
                            </div>
                        ...
                        <div class="mt-8">
                            ...
                            <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                                <div>
                                    ...
                                    <div class="form-input bg-slate-100 dark:bg-zink-600 border-slate-300 dark:border-zink-500 text-slate-500 dark:text-zink-200" readonly>
                                        PKR {{ number_format($user->currentSalary->basic_salary, 2) }}
                                    </div>
                                </div>
                                ...
                                <div>
                                    ...
                                    <div class="form-input bg-slate-100 dark:bg-zink-600 border-slate-300 dark:border-zink-500 text-slate-500 dark:text-zink-200" readonly>
                                        PKR {{ number_format((float)($user->currentSalary->punctuality ?? 0), 2) }}
                                    </div>
                                </div>
                                ...
                                <div>
                                    ...
                                    <div class="form-input bg-slate-100 dark:bg-zink-600 border-slate-300 dark:border-zink-500 text-slate-500 dark:text-zink-200" readonly>
                                        PKR {{ number_format((float)($user->currentSalary->basic_salary ?? 0) + (float)($user->currentSalary->punctuality ?? 0), 2) }}
                                    </div>
                                </div>
                                ...
                                <div>
                                    ...
                                    <div class="form-input bg-slate-100 dark:bg-zink-600 border-slate-300 dark:border-zink-500 text-slate-500 dark:text-zink-200" readonly>
                                        {{ $user->currentSalary->effective_date ? \Carbon\Carbon::parse($user->currentSalary->effective_date)->format('M d, Y') : 'N/A' }}
                                    </div>
                                </div>
                            </div>
                        </div>
