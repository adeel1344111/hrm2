...
(function () {
    ...
    function syncDarkClassFromMode(mode) {
    ...
    if (sessionStorage.getItem('defaultAttribute')) {
        ...
        if (JSON.stringify(CurrentLayoutAttributes) !== sessionStorage.getItem('defaultAttribute')) {
            ...
            syncDarkClassFromMode(isLayoutAttributes['data-mode'] || document.documentElement.getAttribute('data-mode') || 'light');
        }
    }

    // Always keep Tailwind `dark` class aligned with data-mode
    // (fixes light mode still showing dark inputs / cards)
    syncDarkClassFromMode(document.documentElement.getAttribute('data-mode') || 'light');
})();
